...
-(NSData*)decryptWithAlgorighm:(CCAlgorithm)algorithm key:(NSData*)key
{
    return [self decryptWithAlgorighm:algorithm mode:kCCModeCBC padding:NO iv:nil key:key];
}
-(NSData*)decryptWithAlgorighm:(CCAlgorithm)algorithm mode:(CCMode)mode padding:(BOOL)padding iv:(NSData*)iv key:(NSData*)key
{
    return [self decryptWithAlgorighm:algorithm mode:mode padding:padding iv:iv key:key options:0];
}
-(NSData*)decryptWithAlgorighm:(CCAlgorithm)algorithm mode:(CCMode)mode padding:(BOOL)padding iv:(NSData*)iv key:(NSData*)key options:(CCModeOptions)options
{
    return [self CipherWithOperation:kCCDecrypt algorighm:algorithm mode:mode padding:padding iv:iv key:key options:options];
}
-(NSData*)encryptWithAlgorighm:(CCAlgorithm)algorithm key:(NSData*)key
{
    return [self encryptWithAlgorighm:algorithm mode:kCCModeCBC padding:NO iv:nil key:key];
}
-(NSData*)encryptWithAlgorighm:(CCAlgorithm)algorithm mode:(CCMode)mode padding:(BOOL)padding iv:(NSData*)iv key:(NSData*)key
{
    return [self encryptWithAlgorighm:algorithm mode:mode padding:padding iv:iv key:key options:0];
}
-(NSData*)encryptWithAlgorighm:(CCAlgorithm)algorithm mode:(CCMode)mode padding:(BOOL)padding iv:(NSData*)iv key:(NSData*)key options:(CCModeOptions)options
{
