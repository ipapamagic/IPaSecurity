...
-( NSData* _Nullable )encryptWithAlgorighm:(CCAlgorithm)algorithm key:(NSData* _Nullable )key;
-(NSData* _Nullable )encryptWithAlgorighm:(CCAlgorithm)algorithm mode:(CCMode)mode padding:(BOOL)padding iv:(NSData* __nullable)iv key:(NSData* __nonnull)key;
-(NSData* _Nullable)encryptWithAlgorighm:(CCAlgorithm)algorithm mode:(CCMode)mode padding:(BOOL)padding iv:(NSData* __nullable)iv key:(NSData* __nonnull)key options:(CCModeOptions)options;
//decryption
-(NSData* _Nullable)decryptWithAlgorighm:(CCAlgorithm)algorithm key:(NSData* __nonnull)key;
-(NSData* _Nullable)decryptWithAlgorighm:(CCAlgorithm)algorithm mode:(CCMode)mode padding:(BOOL)padding iv:(NSData* __nullable)iv key:(NSData* __nonnull)key;
-(NSData* _Nullable)decryptWithAlgorighm:(CCAlgorithm)algorithm mode:(CCMode)mode padding:(BOOL)padding iv:(NSData* __nullable)iv key:(NSData* __nonnull)key options:(CCModeOptions)options;
